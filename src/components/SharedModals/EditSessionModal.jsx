...
const EditSessionModal = ({ open, setOpen, session }) => {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        form.resetFields();
        setSlots([]); // Clear the slots after successful submission
      }
    } catch (error) {
          ...
          <div className="flex gap-12">
            <div className="flex-1">
              ...
              <Form.Item
                label="Location link"
                name="locationLink"
                initialValue={session?.locationLink}
                rules={[
              ...
              <Form.Item
                label="Therapy Type"
                name="therapyType"
                initialValue={session?.therapyType}
              ...
              <Form.Item
                ...
                name="therapist"
                initialValue={session?.therapist}
